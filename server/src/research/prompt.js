...
- "steps": array of strings — the concrete, ordered steps to actually carry out the project from start to finish, in the order they should be done. Typically 5 to 15 steps, each a short actionable instruction.
